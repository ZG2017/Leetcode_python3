# https://leetcode.com/problems/bitwise-ors-of-subarrays/solutions/7026280/bitwise-ors-of-subarrays-pythoncjava-by-mu7uj/
# dp: dp[i] = dp[i-1] | nums[i], where dp[i] is the bitwise OR of all subarrays ending at index i
