# https://leetcode.com/problems/minimum-absolute-difference-between-elements-with-constraint/solutions/4007263/python3-2-heaps-intuitive-answer-by-jkoj-1vfu/
# 2 heaps, one to save the candidate on the left side, one to save the candidate on the right side
import heapq
class Solution:
