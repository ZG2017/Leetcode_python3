# dfs + priority queue:
# dfs to assign the safety value for every cell, and use priority queue to iteratively find the safest path.

# refer: https://leetcode.com/problems/find-the-safest-path-in-a-grid/solutions/5158910/video-explanation-fastest-and-easiest-to-understand-in-3-languages/
